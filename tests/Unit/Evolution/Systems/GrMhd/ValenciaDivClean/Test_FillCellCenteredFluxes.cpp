...
namespace {
SPECTRE_TEST_CASE(
    "Unit.Evolution.Systems.ValenciaDivClean.FillCellCenteredFluxes",
    "[Unit][Evolution]") {
  MAKE_GENERATOR(gen);
  ...
  fill_cell_centered_fluxes(make_not_null(&flux_vars), boundary_vars);
